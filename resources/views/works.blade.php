                        ...
                        <tbody>
                           @foreach($myworkdata as $value)
                            <tr>
                                ...
                                <td class="text-center">
                                    <button type="button" onclick="getDatafromDB('{{$value->id_work}}')" data-id="{{$value->id_work}}" class="btn btn-success" data-toggle="modal" data-target="#exampleModal2">
                                      Edit
                                    </button>
                                    <button type="button" onclick="DeleteDatafromDB('{{$value->id_work}}')" data-id="{{$value->id_work}}" class="btn btn-danger">
                                        Delete</button>
                                    <a href="/works/{{$value->id_work}}"><button class="btn btn-info">Details</button></a>
                                </td>
                            </tr>
                         @endforeach   
                        </tbody>
